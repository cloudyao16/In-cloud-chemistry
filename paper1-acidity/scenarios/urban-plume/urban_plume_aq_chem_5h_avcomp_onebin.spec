...
output_prefix out_5h_avcomp_onebin/urban_plume_aq_chem_b   # prefix of output files
n_repeat 1                      # number of Monte Carlo repeats
n_part 1000                     # total number of particles
restart yes                     # whether to restart from saved state (yes/no)
restart_file out/urban_plume_0001_00000006_avcom_onebin.nc

t_max 600                      # total simulation time (s)
del_t 1                         # timestep (s)
t_output 60                     # output interval (0 disables) (s)
t_progress 30                   # progress printing interval (0 disables) (s)
...
start_time 18000                 # start time (s since 00:00 UTC)
